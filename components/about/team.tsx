...
const Team: React.FC = () => {
  return (
    <Motioned.container
      id="about-team"
      className="w-full h-max lg:h-screen bg-light"
    >
      <Motioned.wrapper className="w-full lg:h-full flex flex-col-reverse lg:grid lg:grid-cols-8 xl:grid-cols-12">
        <>
          <Motioned.container className="h-full flex flex-col justify-center pt-16 pb-16 px-8 lg:px-16 lg:py-28 lg:col-span-5 xl:col-span-7">
          ...
          <Motioned.container className="h-full flex flex-col justify-center lg:col-span-3 xl:col-span-5 relative">
            <>
              ...
              <Motioned.content className="px-8 pt-16 pb-16 lg:px-16 lg:py-28 w-full h-full flex flex-col justify-center mx-auto backdrop-blur-lg bg-gradient-to-b lg:bg-gradient-to-r from-tangerine/80 to-sunflower/80">
                <>
                  <Motioned.content>
                    <>
