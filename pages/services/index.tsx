...
const MotionedServices: NextPage = () => {
  ...
  return (
    <React.Fragment>
      ...
      <div
        className={reactClassName(
          'fixed z-20 shadow-2xl w-10/12 max-w-xl mx-auto rounded-xl shadow-black top-1/2 left-1/2 -translate-x-1/2 transform transition-all ease-in-out p-8 bg-dark/90 backdrop-blur-md',
          modalView
      ...
      >
        <>
          <span
            className={reactClassName(
              'absolute left-0 -top-1 h-3 transition-all bg-melon rounded-full',
              userSelect ? 'w-full' : 'w-0'
            )}
          />
                  ...
                  <p className="w-full px-4 text-center font-medium font-sand lg:font-bold lg:text-xl">
                    ...
                    >
                      <a className="w-max mx-auto lg:mx-0 text-lg lg:text-xl block transition-all hover:opacity-50 pl-0 border-l-0 border-transparent lg:hover:pl-4 lg:hover:border-l-8 lg:hover:border-light">
                        Explore{' '}
                        <span className="font-bold font-sand bg-clip-text text-transparent bg-gradient-to-r from-ocean to-melon">
